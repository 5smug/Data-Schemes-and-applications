...
<head>
    ...
    <!-- This is here and not in index.php for the same reason as stated in london.php -->
...
<body>
    ...
    <main class="container">
        ...
        <section class="maps-section">
            <h2>City Map</h2>
            <!-- Display of map with data attributes for New York coordinates and city identifier -->
        ...
        <section class="weather-section">
            ...
            <!-- Shows the weather for New York, the script for it is shown in weather.php and below -->
        ...
        <section class="places-section">
            ...
            <div class="places-grid">
                ...
                ?>
                    <?php
                    // Query to fetch all places of interest for New York City, shown in tuesday_assigment.sql and database
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            // Checks if the main.js function is available for more advanced weather loading
            if (typeof loadWeatherForCity === 'function') {
                loadWeatherForCity('New York', 'weather-display');
            } else {
                // Below is the information fetched for NYC weather as a fallback
